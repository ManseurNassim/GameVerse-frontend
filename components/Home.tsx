...
const Home: React.FC = () => {
  ...
  return (
    <div className="pb-10 bg-[#0e0f10] min-h-screen text-white font-roboto">
      <section className="relative w-full h-[50vh] md:h-[55vh] flex items-center justify-center overflow-hidden pt-16 md:pt-0">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0e0f10]/50 to-[#0e0f10]"></div>
        <img src={afficheBg} alt="Bannière GameVerse" className="absolute inset-0 w-full h-full object-cover object-top opacity-85" />
      ...
      <section className="px-4 md:px-8 max-w-7xl mx-auto -mt-20 md:-mt-28 relative z-10">
